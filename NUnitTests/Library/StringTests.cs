...
namespace UnitTests
{
    ...
    public class StringTests
    {
        ...
        public void anchor()
        {
			StringAssert.AreEqualIgnoringCase(@"<a name=""undefined"">haha</a>", (string)TestUtils.Evaluate("'haha'.anchor()"));
			StringAssert.AreEqualIgnoringCase(@"<a name=""test"">haha</a>", (string)TestUtils.Evaluate("'haha'.anchor('test')"));
        ...
        public void big()
        {
			StringAssert.AreEqualIgnoringCase("<big>haha</big>", (string)TestUtils.Evaluate("'haha'.big()"));
        ...
        public void blink()
        {
			StringAssert.AreEqualIgnoringCase("<blink>haha</blink>", (string)TestUtils.Evaluate("'haha'.blink()"));
        ...
        public void bold()
        {
			StringAssert.AreEqualIgnoringCase("<b>haha</b>", (string)TestUtils.Evaluate("'haha'.bold()"));
        ...
        public void @fixed()
        {
			StringAssert.AreEqualIgnoringCase("<tt>haha</tt>", (string)TestUtils.Evaluate("'haha'.fixed()"));
        ...
        {
			StringAssert.AreEqualIgnoringCase(@"<font color=""undefined"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontcolor()"));
			StringAssert.AreEqualIgnoringCase(@"<font color=""red"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontcolor('red')"));
        ...
        {
			StringAssert.AreEqualIgnoringCase(@"<font size=""5"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontsize(5)"));
			StringAssert.AreEqualIgnoringCase(@"<font size=""abc"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontsize('abc')"));
			StringAssert.AreEqualIgnoringCase(@"<font size=""undefined"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontsize()"));
        ...
        public void italics()
        {
			StringAssert.AreEqualIgnoringCase("<i>haha</i>", (string)TestUtils.Evaluate("'haha'.italics()"));
        ...
        public void link()
        {
			StringAssert.AreEqualIgnoringCase(@"<a href=""undefined"">haha</a>", (string)TestUtils.Evaluate("'haha'.link()"));
			StringAssert.AreEqualIgnoringCase(@"<a href=""http://www.beer.com"">haha</a>", (string)TestUtils.Evaluate("'haha'.link('http://www.beer.com')"));
        ...
        public void small()
        {
			StringAssert.AreEqualIgnoringCase("<small>haha</small>", (string)TestUtils.Evaluate("'haha'.small()"));
        ...
        public void strike()
        {
			StringAssert.AreEqualIgnoringCase("<strike>haha</strike>", (string)TestUtils.Evaluate("'haha'.strike()"));
        ...
        public void sub()
        {
			StringAssert.AreEqualIgnoringCase("<sub>haha</sub>", (string)TestUtils.Evaluate("'haha'.sub()"));
        ...
        public void sup()
        {
			StringAssert.AreEqualIgnoringCase("<sup>haha</sup>", (string)TestUtils.Evaluate("'haha'.sup()"));
